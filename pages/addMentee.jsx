            ...
            <div className="sm:px-12">
                ...
                <div className="justify-between sm:flex">
                    <div className="px-1 ">
                        ...
                        <Inputaddmentee type="number" label="Class Id" placeholder="Class Id" onChange={(e) => setClassId(e.target.value)} />
                    </div>
                    <div className="px-1">
                        ...
                        <Inputaddmentee type="text" label="Phone Number" placeholder="Phone Number of Spouse/parent/sibling" onChange={(e) => setPhoneEd(e.target.value)} />
                ...
                <div className="flex justify-end ">
                    ...
                    <button onClick={() => handleAddMentee()} className="rounded-lg bg-[#1B345F] text-lg py-2 w-28 text-white" type="submit">
                        Save
                    </button>
                </div>
                {/* </div> */}

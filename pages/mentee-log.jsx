            ...
            <div className="w-full px-1 lg:px-12 ">
                ...
                <div>
                    <div className="flex flex-wrap justify-between flex-col md:flex-row  w-full xl:w-[900px] mt-5">
                        ...
                        <div className="order-2 ml-10 md:ml-0 md:order-1 ">
                            <div className="flex items-center mb-5">
                                ...
                                <p className="ml-5 text-xs font-roboto text-biruAlta">John Doe</p>
                            </div>
                            <div className="flex items-center mb-5">
                                <ImLibrary className="text-biruAlta " size={28} />
                                <p className="ml-5 text-xs font-roboto text-biruAlta">Queality Engineer Batch 3</p>
                            </div>
                            <div className="flex items-center mb-5">
                                <FaGraduationCap className="text-biruAlta" size={28} />
                                <p className="ml-5 text-xs font-roboto text-biruAlta">Politeknik Negeri Jakarta</p>
                            </div>
                        </div>
                        ...
                        <div className="order-3 ml-10 md:ml-0">
                            <div className="flex items-center mb-5">
                                ...
                                <p className="ml-5 text-xs font-roboto text-biruAlta">08123456789</p>
                            </div>
                            <div className="flex items-center mb-5 ">
                                <TbBrandTelegram className="text-biruAlta " size={28} />
                                <p className="ml-5 text-xs font-roboto text-biruAlta">@johndoe#2345</p>
                            </div>
                            <div className="flex items-center mb-5">
                                <TbMail className="text-biruAlta" size={28} />
                                <p className="ml-5 text-xs font-roboto text-biruAlta">John@alterra.id</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end w-full mt-7">
                        <button className="px-8 py-2 rounded-lg bg-biruAlta hover:bg-orangeAlta text-putihAlta" onClick={() => setShowModal(true)}>
                            Add New Log
                        </button>
                    </div>
                    ...
                    <div className="w-full p-2 mt-3 rounded-md shadow-md shadow-biruAlta/50 ">
                        <div className="flex flex-col items-center md:flex-row ">
                            <h3 className=" w-full md:w-[20%] px-2 text-center md:text-left text-base font-poppins text-biruAlta">End of Section Bagas Sep 27, 2022</h3>
                            <p className=" w-ful mt-2 md:mt-0 md:w-[80%] md:px-3 text-sm  font-roboto text-biruAlta">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quis obcaecati molestiae modi voluptatibus doloremque vero amet maxime eos alias nesciunt!
                                Repudiandae obcaecati nemo molestiae, alias perferendis inventore assumenda, magnam dolores dolorum consequatur nesciunt cum ipsum iure eum soluta
                                adipisci dignissimos laborum labore doloremque perspiciatis maiores, suscipit modi. Perferendis deleniti fuga rerum odio fugiat, reprehenderit
                                officia deserunt amet sed expedita, repudiandae libero? Error quod repellat nam quo sint odit quidem. necessitatibus maxime quidem doloribus
                                blanditiis molestiae.
                            </p>
                        </div>
                        <div className="flex items-center justify-center mt-5">
                            <h3 className="text-lg text-biruAlta">Changed Status: Join Class </h3>
                                ...
                                <div className="relative w-auto max-w-3xl mx-auto my-6">
                                    <div className="relative flex flex-col w-full bg-white rounded-lg shadow-lg outline-none focus:outline-none">
                                        <div className="relative flex-auto p-0 sm:p-3 ">
                                            <form className="w-full px-8 py-6 rounded shadow-md" onSubmit={(e) => addFeedback(e)}>
                                                ...
                                                <div className="flex items-center justify-center w-full">
                                                    ...
                                                    >
                                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                                            ...
                                                            <p className="text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG or GIF (Maximum file size 10MB)</p>
                                                        </div>
                                                        <input
                                                            id="dropzone-file"
                                                            type="file"
                                                ...
                                                <div className="">
                                                    <div className="mb-3 xl:w-96">
                                                        ...
                                                        >
                                                            ...
                                                            <option value="2" onClick={(e) => setStatus("Active")}>
                                                                Active
                                                            </option>
                                                            <option value="3" onClick={(e) => setStatus("Non-Active")}>
                                                                Non-Active
                                                            </option>
                                                        </select>
                                                    </div>

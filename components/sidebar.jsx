    ...
    return (
        <div className='w-full sm:w-52 bg-[#F0F4FD] px-2 sm:px-[35px] py-[37px] text-lg'>
            ...
            <div className='mt-4 w-full notdropnav:hidden flex justify-center text-xl text-[#1B345F] '>
                ...
                >
                    <MenuItem className='hover:bg-[#1B345F] hover:text-white' onClick={handleClose}><Icon className='mt-2 mr-2' icon="carbon:dashboard" />Dasboard</MenuItem>
                    <MenuItem className='hover:bg-[#1B345F] hover:text-white' onClick={handleClose}><Icon className='mt-2 mr-2' icon="ph:student" />Mentee</MenuItem>
                    <MenuItem className='hover:bg-[#1B345F] hover:text-white' onClick={handleClose}><Icon className='mt-2 mr-2' icon="clarity:user-line" />User</MenuItem>
                    <MenuItem className='hover:bg-[#1B345F] hover:text-white' onClick={handleClose}><Icon className='mt-2 mr-2' icon="eos-icons:storage-class-outlined" />Class</MenuItem>

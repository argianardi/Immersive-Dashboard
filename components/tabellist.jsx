...
const Tabellist = ({ judultabel, tabel, deleteUser }) => {
    return (
                        ...
                        return (
                            <>
                                <tr className='border-[#bababa] border-b-[1px]' style={{ border: '1px solid #000' }} key={index}>
                                    ...
                                    <td><button onClick={() => deleteUser(item.id)} className='active:bg-[#1B345F] text-[#21a41f] active:text-white rounded'><Icon icon="fluent:delete-12-regular" width="22" height="22" /></button></td>
                                </tr>
                            </>
                        );
                    })}

...
const Search = ({ showingmodal }) => {
    return (
        <div className='flex justify-end mt-[17px]'>
            ...
            <button className='text-[15px] py-1.5 text-white active:bg-[#F7731C] bg-[#1B345F] border-r-[1px] border-y-[1px] rounded-r-md border-[#1B345F] active:border-[#F7731C] w-24 h-[#35] text-center' onClick={showingmodal}>Add New</button>
        </div>
    )
}
